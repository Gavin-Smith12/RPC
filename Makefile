...
LDFLAGS = 
INCLUDES = $(C150LIB)c150streamsocket.h $(C150LIB)c150network.h $(C150LIB)c150exceptions.h $(C150LIB)c150debug.h $(C150LIB)c150utility.h $(C150LIB)c150grading.h $(C150IDSRPC)IDLToken.h $(C150IDSRPC)tokenizeddeclarations.h  $(C150IDSRPC)tokenizeddeclaration.h $(C150IDSRPC)declarations.h $(C150IDSRPC)declaration.h $(C150IDSRPC)functiondeclaration.h $(C150IDSRPC)typedeclaration.h $(C150IDSRPC)arg_or_member_declaration.h rpcproxyhelper.h rpcstubhelper.h arithmetic.idl floatarithmetic.idl 

all: arithmeticclient arithmeticserver floatarithmeticclient floatarithmeticserver pingstreamclient pingstreamserver idldeclarationtst idl_to_json arrayandstructclient arrayandstructserver
...
# of functions, by linking the right specific stubs (in this case
...
##############################################
# Arithmetic hand-generated stub/proxy rules #
##############################################
...
arrayandstructclient: arrayandstructclient.o rpcproxyhelper.o arrayandstruct.proxy.o  $(C150AR) $(C150IDSRPCAR)  $(INCLUDES)
	$(CPP) -o arrayandstructclient arrayandstructclient.o rpcproxyhelper.o arrayandstruct.proxy.o  $(C150AR) $(C150IDSRPCAR) 

arrayandstructserver: arrayandstruct.stub.o rpcserver.o rpcstubhelper.o arrayandstruct.o  $(C150AR) $(C150IDSRPCAR)  $(INCLUDES)
	$(CPP) -o arrayandstructserver rpcserver.o arrayandstruct.stub.o arrayandstruct.o rpcstubhelper.o $(C150AR) $(C150IDSRPCAR) 
